  ...
  >
    <div>
      ...
      <p v-if="isEdit" class="tips center">
        部分新发基金或QDII基金可以搜索到，但可能无法获取估值情况。      </p>
      <div
        v-if="isGetStorage"
        ...
        <table :class="tableHeight">
          <thead>
            <tr>
              ...
              <th @click="sortList('amount')" v-if="showAmount" class="pointer">
                持有量                <span :class="sortType.amount" class="down-arrow"></span>
              </th>
              <th
          ...
          <tbody>
            ...
            >
              ...
              >
                <span class="hasReplace-tip" v-if="el.hasReplace">删</span>{{ el.name }}
              </td>
    ...
    <div class="input-row" v-if="showCost || showGains">
      <input
        ...
        type="button"
        :title="
          allGains[0] >= 0 ? 'd=====(￣▽▽)b 赞一个' : '∑っ°Д°)っ 大事不好'
        "
        :value="
          '日收益：' +
  ...
  methods: {
    ...
    handleDragEnter(e, item, index) {
      ...
      if (this.dragging && this.dragging.fundcode && item.fundcode) {
        ...
        //数据列表也同步更新        const newDataItems = [...this.dataList];
